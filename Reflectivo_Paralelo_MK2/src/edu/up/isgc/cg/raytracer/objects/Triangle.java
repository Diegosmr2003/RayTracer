 ...
 *  Date: 2024-06-06
 *   Description:
 *   This class represents a triangle object in a ray tracing environment. Triangles are defined by three vertices
 *   in 3D space. The class implements the IIntersectable interface, allowing it to compute intersections with rays.
 *   Triangles can either have explicit vertex normals or compute a face normal if none are provided.
 *
 */
